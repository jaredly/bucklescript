...
/**
# Got to build ocaml-migrate-parsetree first tho
# cd ../../reason/bspacks/ocaml-migrate-parsetree
# find & replace, in Ast_402.ml
# (regex search)  \(\*IF_CURRENT([^*]+)\*\) with $1
# replace OCaml_OCAML_VERSION with OCaml_402
# PATH=../../../bucklescript/vendor/ocaml/bin/:~/.opam/4.02.3/bin:$PATH make cinaps
# PATH=../../../bucklescript/vendor/ocaml/bin/:$PATH jbuilder build
...
reasonTargetDir=../../reason
ocamlMigrateParseTreeTargetDir="../../reason/bspacks/ocaml-migrate-parsetree/_build/default/src"
...
grep -r -q require_20170418 $menhirSuggestedLib || (echo "Wrong version of menhir! You need menhir.20170418"; exit 1)

PATH=../vendor/ocaml/bin/:$PATH

# ./bin/bspack.exe -D BS_COMPILER_IN_BROWSER=true -U BS_DEBUG -bs-MD  \
#   -module-alias Config=Config_whole_compiler  -bs-exclude-I config \
#   -o playground_compiler.ml \
#   -bs-main Jsoo_main \
#   -I ${OCAML_SRC_UTILS} -I ${OCAML_SRC_PARSING} -I ${OCAML_SRC_TYPING} \
#   -I ${OCAML_SRC_BYTECOMP} -I ${OCAML_SRC_DRIVER} \
#   -I stubs -I ext -I syntax -I depends -I common -I core -I super_errors \
#   -I bsb -I outcome_printer

# echo "Bucklescript"
# ocamlc.opt -w -30-40 -no-check-prims -I bin playground_compiler.ml -o bs-play.byte
js_of_ocaml --disable share --toplevel +weak.js ./polyfill.js jsc.byte ${includes} ${cmi_files} -o ${playground}/bucklescript-compiler.js
...
# echo "Refmt"
# ocamlc -g -no-alias-deps -w -40 -I +compiler-libs ocamlcommon.cma refmt_jsoo.ml -o refmt.byte


./bin/bspack.exe -D BS_COMPILER_IN_BROWSER=true -U BS_DEBUG -bs-MD  \
  -module-alias Config=Config_whole_compiler  -bs-exclude-I config \
  -o playground_compiler_with_refmt.ml \
  -bs-main Jsoo_main_refmt \
  -I ${OCAML_SRC_UTILS} -I ${OCAML_SRC_PARSING} -I ${OCAML_SRC_TYPING} \
  -I ${OCAML_SRC_BYTECOMP} -I ${OCAML_SRC_DRIVER} \
  -I stubs -I ext -I syntax -I depends -I common -I core -I super_errors \
...
ocamlc.opt -g -w -30-40 -no-check-prims -I +compiler-libs ocamlcommon.cma -I bin playground_compiler_with_refmt.ml -o bs-play.byte
